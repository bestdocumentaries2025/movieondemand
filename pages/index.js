...
export default function Home({ movies }) {
  ...
  const loadMoreAll = () => setAllMoviesLimit(prev => prev + 15)
  const loadMoreAdult = () => setAdultMoviesLimit(prev => prev + 15)
  const loadMoreSearch = () => setSearchResultsLimit(prev => prev + 15)
      ...
      "@graph": [
        {
          ...
          "alternateName": "Movie On Demand - Movie within 24 hours",
          "potentialAction": [
            {
              "@type": "SearchAction",
              "target": {
        ...
        },
        {
          ...
          "@id": `${SITE_URL}#webpage`,
          "url": SITE_URL,
          "name": `${siteName} - Request Any Movie via Telegram`,
          "isPartOf": {
            "@id": `${SITE_URL}#website`
          },
          "description": siteDescription,
        ...
        },
        {
          "@type": "ItemList",
          "name": "Latest Movies Collection",
          "description": "Collection of latest movies available on demand",
          "numberOfItems": movies.length,
          "itemListElement": movies.slice(0, 20).map((movie, index) => ({
            "@type": "ListItem",
            "position": index + 1,
  ...
  return (
    <div className="min-h-screen bg-black">
      <Head>
        <title>{siteName} - Request Any Movie via Telegram</title>
        <meta name="description" content={siteDescription} />
        ...
        {/* Open Graph */}
        <meta property="og:title" content={`${siteName} - Request Any Movie via Telegram`} />
        <meta property="og:description" content={siteDescription} />
        <meta property="og:type" content="website" />
        ...
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content={`${siteName} - Request Any Movie via Telegram`} />
        <meta property="og:site_name" content={siteName} />
        <meta property="og:locale" content="en_US" />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${siteName} - Request Any Movie via Telegram`} />
        <meta name="twitter:description" content={siteDescription} />
        <meta name="twitter:image" content={`${SITE_URL}/og-image.jpg`} />
        <meta name="twitter:image:alt" content={`${siteName} - Request Any Movie via Telegram`} />
